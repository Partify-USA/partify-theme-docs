...
description: A map of the Partify USA technical documentation — what each section covers and where to go based on what you're trying to do.
...
Welcome. This site documents the **Partify USA technical stack** — the Shopify
...
- **Why before what.** Pages explain intent, constraints, and what breaks if
  something changes — the code already shows the *how*.
